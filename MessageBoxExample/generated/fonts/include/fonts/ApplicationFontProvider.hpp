...
{
    static const touchgfx::FontId LARGE = 0;   // Roboto_Medium_40_4bpp
    static const touchgfx::FontId SMALL = 1;   // Roboto_Medium_10_4bpp
    static const touchgfx::FontId DEFAULT = 2; // Roboto_Medium_20_4bpp
